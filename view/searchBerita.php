            ...
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo '<div class="col-lg-6 video-box">';
                        echo '<a href="showBerita.php?Id_Berita='.$row['Id_Berita'].'"><img src="'.$row["url_Gambar"]. '" class="img-fluid" alt="" style="width:700px;">';
                    echo "</div>";

                    echo '<div class="col-lg-6 d-flex flex-column justify-content-center p-5">';
                        echo '<div class="test">';
                        echo '<h4 class="title"><a href="showBerita.php?Id_Berita='.$row['Id_Berita'].'">'.$row['judul_Berita'].'</a></h4>';
